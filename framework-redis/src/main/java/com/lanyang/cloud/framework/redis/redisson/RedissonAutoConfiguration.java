 ...
 */
package com.lanyang.cloud.framework.redis.redisson;

import com.lanyang.cloud.framework.redis.annotation.RedisTopic;
...
public class RedissonAutoConfiguration {
    ...
    public RedissonClient redisson() throws IOException {
        ...
        String[] beanNamesForType = ctx.getBeanNamesForType(MessageListener.class);
        for (String beanName : beanNamesForType) {
            //通过bean名字获取到监听bean
            MessageListener bean = ctx.getBean(beanName, MessageListener.class);
