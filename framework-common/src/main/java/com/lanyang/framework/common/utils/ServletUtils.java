...
import com.lanyang.framework.common.constant.Constants;
...
//    }
    ...
    /**
     * 获取用户登录时生成的唯一key
     * 登录时生成，放到token里，网关过滤器过滤时取出，放到请求头
     * @return
     */
    public static String getUserKey() {
        return getUserKey(ServletUtils.getRequest());
    }
    ...
    private static String getTenantId(HttpServletRequest request) {
        // 从header获取USER_KEY标识
        return request.getHeader(SecurityConstants.TENANT_ID);
    }
